...
var file_city_service_proto_rawDesc = []byte{
	...
	0x32, 0xe4, 0x01, 0x0a, 0x0d, 0x43, 0x69, 0x74, 0x69, 0x65, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x62, 0x2f, 0x63, 0x69,
...
var file_city_service_proto_depIdxs = []int32{
	...
	0, // 5: cities.CitiesService.GetCitylocal:output_type -> cities.City
	0, // 6: cities.CitiesService.GetCity:output_type -> cities.City
	0, // 7: cities.CitiesService.Create:output_type -> cities.City
	0, // 8: cities.CitiesService.Update:output_type -> cities.City
	3, // 9: cities.CitiesService.Delete:output_type -> cities.MyBoolean
